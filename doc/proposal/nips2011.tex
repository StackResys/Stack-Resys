...
Papers to be submitted to NIPS 2011 must be prepared according to the
...
The margins in 2011 are the same as since 2007, which allow for $\approx 15\%$
...
%%
%% \textbf{THE SUBMISSION DEADLINE IS JUNE 2, 2011. SUBMISSIONS MUST BE LOGGED BY
%% 23:59, JUNE 2, 2011, UNIVERSAL TIME}
...
\begin{center}
   http://www.nips.cc/
\end{center}
The file \verb+nips2011.pdf+ contains these 
...
\verb+nips2011.tex+ may be used as a ``shell'' for writing your paper. All you
have to do is replace the author, title, abstract, and text of the paper with
your own. The file
\verb+nips2011.rtf+ is provided as a shell for MS Word users.
